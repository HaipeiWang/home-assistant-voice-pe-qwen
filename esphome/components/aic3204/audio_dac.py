...
CODEOWNERS = ["@kbx81"]
DEPENDENCIES = ["i2c"]
# ESPHome 2026.7.4's IDF component discovery does not infer this base
# component from the Python import above. Without an explicit autoload the
# generated source contains audio_dac.h, but the include directory is omitted.
AUTO_LOAD = ["audio_dac"]
